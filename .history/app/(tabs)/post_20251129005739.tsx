...
// Helper function to render Picker Items to avoid the React.Children.only error
const renderCategoryItems = () => {
    return CATEGORY_CHOICES.map(cat => (
...
      // NOTE: Replaced alert() with console.log as alerts are discouraged.
...
                style={styles.picker}
              >
                {/* Fix: Using the helper function to render items for stability */}
                {renderCategoryItems()} 
              </Picker>
            </View>
