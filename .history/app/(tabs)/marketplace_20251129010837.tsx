...
export default function Marketplace() {
    ...
    // State for the immediate user input
    const [searchTerm, setSearchTerm] = useState("");
    // Debounced term for filtering (runs after 300ms pause)
    ...
    // --- Data Fetching Logic (Optimized for Category Change) ---
    const fetchProducts = useCallback(async () => {
        setIsLoading(true);
        try {
            // Category filtering is handled here by the API call
    ...
    // Local filtering based on the DEBOUNCED search query
    ...
    }, [products, debouncedSearchQuery]); // Only re-run when products or debouncedQuery changes
    ...
    const renderProduct = ({ item }: { item: Product }) => (
        <TouchableOpacity
            ...
            onPress={() => {
                if (item.id) {
                    // This is the correct way to navigate to the detail page
        ...
        >
            <Image 
                ...
                style={styles.image} 
                defaultSource={require('../../assets/images/placeholder.png')} // Use a local placeholder
            /> 
    ...
    const renderEmptyState = () => (
        <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyTitle}>
                {debouncedSearchQuery ? 'No Matching Listings' : `No Items Available`}
            </Text>
        ...
        <SafeAreaView style={styles.safeArea} edges={['top']}>
            <View style={styles.container}>
                        ...
                        {categories.map((cat) => {
                            ...
                            return (
                                <TouchableOpacity
                                    ...
                                    onPress={() => {
                                        // Set category (triggers API fetch) and clear search term
                ...
                <FlatList
                    ...
                    // Animated.FlatList is not needed since the header is fixed now
                />
            </View>
        </SafeAreaView>
    );
...
const styles = StyleSheet.create({
    ...
    searchBar: { 
        flexDirection: "row", 
        alignItems: "center", 
        backgroundColor: BACKGROUND_LIGHT, // Use light background for search field
        borderRadius: 10, 
        paddingHorizontal: 15,
        marginHorizontal: 15,
        marginBottom: 5,
    ...
    categoriesWrapper: {
        ...
        paddingVertical: 10,
        borderBottomWidth: 1,
        borderBottomColor: BORDER_LIGHT, // Use a lighter border
    },
