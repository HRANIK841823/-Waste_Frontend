...
      <TouchableOpacity style={styles.buttonPurchase} onPress={() => router.push("/PurchaseHistory")}>
        <Text style={styles.buttonText}>Purchase History</Text>
      </TouchableOpacity>
      {/* Renamed "Order History" to "Sell History" for clarity */}
      <TouchableOpacity style={styles.buttonPurchase} onPress={() => router.push("/SellHistory")}> 
