...
      <TouchableOpacity style={styles.buttonPurchase} onPress={() => router.push("/purchase-history")}>
        <Text style={styles.buttonText}>Purchase History</Text>
      </TouchableOpacity>
      {/* Renamed "Order History" to "Sell History" for clarity */}
      <TouchableOpacity style={styles.buttonPurchase} onPress={() => router.push("/sell-history")}> 
