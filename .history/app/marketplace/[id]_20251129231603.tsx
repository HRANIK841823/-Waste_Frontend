...
    currentUserId: string | null, // Use ID directly
    users: User[]
  ) => {
    
...
    }
    // Case 3: Owner viewing their own available item (show their own seller info)
    else if (isOwner && loadedProduct.status === 'available') {
        contactUserId = loadedProduct.seller_id;
        isContactBuyer = false; 
    }
    // 💥 NEW Case 4: General Customer/Buyer viewing an available item 💥
