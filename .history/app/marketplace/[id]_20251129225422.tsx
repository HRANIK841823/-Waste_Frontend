...
export default function ProductDetails() {
  ...
  // Function to fetch all users from the new API endpoint
  ...
  const setRelevantContact = (
    ...
    let isContactBuyer = false; // Is the user whose contact we are fetching the BUYER?
          ...
          <View style={styles.contactRow}>
            ...
            >
              <Text style={[styles.contactValue, contact.phone_number !== 'N/A' && styles.contactValueLink]} numberOfLines={1}>
                {contact.phone_number || 'N/A'} {/* CORRECTED: using phone_number */}
              </Text>
            </TouchableOpacity>
          </View>
          <View style={styles.contactRow}>
