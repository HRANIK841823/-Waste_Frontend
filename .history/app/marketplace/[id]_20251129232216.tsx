...
export default function ProductDetails() {
   ...
   * 1. Owner viewing pending/sold item (shows Buyer contact).
   * 2. Buyer viewing pending/sold item (shows Seller contact).
   * 3. Owner viewing available item (shows Owner/Seller contact).
   * 4. Customer viewing available item (shows Seller contact).
   */
