...
const getItemDetail = (_id) => API.get(`/marketplace/${_id}/`);
const updateItem = (_id, payload) => API.put(`/marketplace/${_id}/`, payload);
const deleteItem = (_id) => API.delete(`/marketplace/${_id}/`);
