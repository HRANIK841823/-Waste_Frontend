...
const API = axios.create({
  baseURL: "http://192.168.0.111:8000/api", // ⬅️ keep or change to your server URL
  timeout: 10000,
});
...
const createItem = (payload) => API.post("/marketplace/marketplace/marketplace/", payload);
...
const buyItem = (item_id) => API.post(`/marketplace/${item_id}/buy/`);
