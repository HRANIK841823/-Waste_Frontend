...
export default function Login() {
  ...
  const handleLogin = async () => {
    try {
      const res = await api.login(email, password); // send email not username
...
          <Text style={styles.createAccount}>Dont have an account? 
          </Text><Text style={styles.link}>Create one</Text>
        </TouchableOpacity>
