...
// --- CORRECTED IMPORT ---
// Changing 'import * as API from '../api'' to 'import API from '../api''
// This is the correct way to import a module that uses 'export default { ... }'
import API from '../../api';
// --- END CORRECTION ---
...
const CATEGORY_CHOICES = [
    ...
    'Home Decor', 'Toys', 'Appliance', 'Other'
];
...
export default function EditWasteItemScreen() {
    ...
    const { data: productData, isLoading, isError, error, refetch } = useQuery<FetchedProduct>({
        ...
        queryFn: async () => {
            ...
            // API.getItemDetail is called directly on the imported object, which is now the default export.
